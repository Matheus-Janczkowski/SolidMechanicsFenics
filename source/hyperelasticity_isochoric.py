...
dkvol_dJModel, file_displacementName, file_vonMisesName, T_max):
    ...
    C_elastic = elastic_tensors.C_hyperIsochoric(C, I1_iso, I2_iso, 
    k_vol, J, dkvol_dJ, dPsi_dI1Iso, dPsi_dI2Iso, ddPsi_ddI1Iso, 
    ddPsi_ddI2Iso, ddPsi_dI1dI2Iso, dimension)
